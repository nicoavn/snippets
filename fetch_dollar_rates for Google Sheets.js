 ...
 */
function readRows() {
  var sheet = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("Monthly Movements");
  var data = ImportJSON("https://2gzlvp5m4d6uqvcqzm46kfgjee0pjhgo.lambda-url.us-east-1.on.aws/")
  sheet.getRange("I23").setValue(data[1][0]);
  sheet.getRange("J23").setValue(data[1][1]);
  sheet.getRange("J2").setValue(new Date().toLocaleDateString("es-DO"));
};
